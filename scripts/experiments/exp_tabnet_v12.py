"""
TabNet Experiment v12
=====================
Training TabNetClassifier on v12 dataset.
Uses explicit categorical embeddings for high-cardinality features.
"""
import pandas as pd
import numpy as np
import torch
...
# Config
EXP_NAME = 'exp_tabnet_v12_baseline'
...
clf = TabNetClassifier(
    ...
    cat_idxs=cat_idxs,
    cat_dims=cat_dims,
    cat_emb_dim=10, # Increased from 1
...
# Save
print("Saving model...")
saved_filepath = clf.save_model(os.path.join(OUTPUT_DIR, 'tabnet_model_v2'))
