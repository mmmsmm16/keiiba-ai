...
def main():
    logger.info("🚀 Starting M4-B Step 1: Feature Generation (M4-B-Top3)")
    ...
    FEATURE_BLOCKS = [
        ...
        'class_stats' # M4-B Feature
    ]
    # Pruned version matching M4-A + Class Stats
    ...
    clean_df[target_cols].to_parquet("data/temp_m4/M4_B_targets.parquet")
    logger.info("Targets saved to data/temp_m4/M4_B_targets.parquet")
    ...
    df_features.to_parquet("data/temp_m4/M4_B_features.parquet")
    logger.info("Features saved to data/temp_m4/M4_B_features.parquet")
