...
def run_evaluation():
    ...
    print("Generating features (08 Refined Logic)...")
    # history_windows should be [1, 2, 3, 4, 5] as in 07
    ...
    # Features list (Notebook 08 logic)
    baseline_features = [
    ...
    print(f"\n--- Evaluation Results (08 Refined Logic) ---")
