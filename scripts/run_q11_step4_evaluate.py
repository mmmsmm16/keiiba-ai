...
def main():
    ...
    # Paths
    FEAT_path = "data/temp_q11/Q11_features.parquet"
    TGT_path = "data/temp_q11/Q11_targets.parquet"
    ...
    # Ensure date is still there (it is in df_targets_2024)
    # Check if duplicate cols appeared
    ...
    # Filter datetime cols
    feature_cols = [c for c in feature_cols if not pd.api.types.is_datetime64_any_dtype(df[c])]
