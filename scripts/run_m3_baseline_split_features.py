...
def main():
    logger.info("🚀 Starting M3 Baseline Reproduction: Feature Generation")
    
    # Config matching M3 (phase_m_top3.yaml)
    ...
    clean_df[target_cols].to_parquet("data/temp_m4/M3_targets.parquet")
    logger.info("Targets saved to data/temp_m4/M3_targets.parquet")
    ...
    df_features.to_parquet("data/temp_m4/M3_features.parquet")
    logger.info("Features saved to data/temp_m4/M3_features.parquet")
    
    logger.info("M3 Step 1 Complete!")
