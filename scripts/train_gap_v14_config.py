...
def _coalesce_columns(df, target, candidates):
...
def _normalize_odds_columns(df):
    # Normalize duplicate columns generated by merge history.
    mapping = {
...
def main():
    ...
    if need_odds_compute:
        ...
        if not df_odds.empty:
            ...
            for c in [
                'odds_10min', 'odds_final', 'odds_60min', 'odds_ratio_10min',
                'rank_diff_10min', 'odds_log_ratio_10min', 'odds_ratio_60_10',
                'odds_10min_x', 'odds_10min_y', 'odds_final_x', 'odds_final_y',
                'odds_60min_x', 'odds_60min_y', 'odds_ratio_10min_x', 'odds_ratio_10min_y',
                'rank_diff_10min_x', 'rank_diff_10min_y',
                'odds_log_ratio_10min_x', 'odds_log_ratio_10min_y',
                'odds_ratio_60_10_x', 'odds_ratio_60_10_y'
            ]:
                if c in df.columns:
    ...
    exclude_cols = [
        ...
        # Final-odds/post-race derived columns are not allowed for production.
        'odds_final', 'odds_ratio_10min', 'odds_log_ratio_10min', 'rank_diff_10min',
        'odds_final_x', 'odds_final_y', 'odds_ratio_10min_x', 'odds_ratio_10min_y',
        'odds_log_ratio_10min_x', 'odds_log_ratio_10min_y',
