...
def run_experiment(config_path: str, strict: bool = False):
    ...
    if not os.path.exists(leaderboard_path):
        with open(leaderboard_path, 'w', encoding='utf-8') as f:
            ...
            f.write("| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |\n")
    row = f"| {exp_name} | {feature_blocks} | {objective} | {valid_year} | {auc_score:.4f} | {ll_score:.4f} | {bs_score:.4f} | {ap_score:.4f} | {ndcg_score_val:.4f} | {recall_at_5_val:.4f} | 0.0% | {dataset_cfg.get('description', '')} |\n"
