...
def main():
    logger.info("🚀 Starting M4-C Step 1: Feature Generation (M4-C-Top3)")
    
    # Config
    START_DATE = "2023-01-01"
    END_DATE = "2024-12-31"
    
    # M4-C = M4-B (Core+Class) + Segment Stats
    FEATURE_BLOCKS = [
        ...
        'class_stats',   # M4-B key feature
        'segment_stats'  # M4-C new feature
    ]
    ...
    clean_df[target_cols].to_parquet("data/temp_m4/M4_C_targets.parquet")
    logger.info("Targets saved to data/temp_m4/M4_C_targets.parquet")
    ...
    df_features.to_parquet("data/temp_m4/M4_C_features.parquet")
    logger.info("Features saved to data/temp_m4/M4_C_features.parquet")
